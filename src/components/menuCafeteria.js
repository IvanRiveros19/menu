...
import crepaDulce from '../img/cafeteria/crepaDulce.jpg'
import logo from '../img/cafeteria/logo.jpg'
import waffles from '../img/cafeteria/waffles.jpg'
import crepaSalada from '../img/cafeteria/crepaSalada.jpg'
import postres from '../img/cafeteria/postres.jpg'
import bebidasFrias from '../img/cafeteria/bebidasFrias.jpg'
import bebidasCalientes from '../img/cafeteria/bebidasCalientes.jpg'

export const MenuCafeteria = () => {

    return (
        <section>
            <img src={logo} width="300" height="300" className="rounded mx-auto d-block mt-4 mb-3" alt="logo" loading="lazy" />
            <div className="container text-light">
                <h1 className="text-center"><span className="texto-naranja-degradado font-weight-bold">Cafeteria Menú</span></h1>
                ...
                <div className="embed-responsive embed-responsive-16by9 mb-5">
                    <iframe
                        ...
                        src="https://maps.google.com/maps?width=520&amp;height=400&amp;hl=en&amp;q=%20Acatlan+()&amp;t=k&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" allowFullScreen>
                    </iframe>
                </div>
            </div>
        </section>
